...
model1=joblib.load('static\9th&10th_Predicator')
...
model5=joblib.load('static\Mathematics_Predicator')
...
pred_mathematics_mapping={
    0: 'Biology, Environmental Science, Bioengineering, or Life Sciences',
    1: 'Engineering related to CS,AI or other Technical field,Biotechnology, Biochemistry, Molecular Biology, Biomedical Engineering, or Bioinformatics',
    2: 'Explore other fields outside Biology, such as Engineering or Business',
}
    ...
    if request.method == 'POST':
        try:
            ...
            input_data = np.array([[
                ...
                0, 0  # Additional features to match the model's requirement (adjust as necessary)
            ]])
